...
public class RecursoController {
    ...
    public String listar(
        ...
        // 🔥 AHORA LISTA SIN LOS COMPLETADOS
        model.addAttribute("recursos",
                servicio.listarFiltradoExcluyendoCompletados(lenguaje, nivel, principal));

        // necesarios para mostrar el botón correcto (marcar/desmarcar)
        model.addAttribute("completadosIds",
                progresoService.idsCompletados(principal));
